...
if (nc == 14) {
	d["predicted"]=(c[1]+c[2]*d[2]+c[3]*d[3]+c[4]*d[4]+c[5]*d[5]+c[6]*d[6]+c[7]*d[7]+c[8]*d[8]+c[9]*d[9]+c[10]*d[10]+c[11]*d[11])/c["t"] # Binding affinity predicted by the newly-trained model, with kcal/mol converted to pKd.
} else if (nc == 94) {
