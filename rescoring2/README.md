...
* `idprplot.R` plots models{1,2,3,4}/set{1,2}/$w/pdbbind-$v-trn-{1,2,3,4,5,6}-tst-{1,2}-dr.tiff.
...
Therefore, the % of complexes where the pose with the best model 2 score also has the lowest RMSD is 143 / 382 = 37%.
