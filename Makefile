...
all: bin/rf-prepare bin/rf-train bin/rf-test bin/rf-score bin/rf-stat bin/rf-extract bin/rf-predict bin/rf-inspect
...
bin/rf-test: obj/random_forest_test.o obj/statistics.o obj/rf-test.o
	$(CC) -o $@ $^
...
bin/rf-stat: obj/statistics.o obj/rf-stat.o
	$(CC) -o $@ $^
