...
boxplot(rmse,main="Median of RMSE",xlab="Number of training complexes",ylab="Root Mean Square Error (Å)",outline=F,boxlty=0,whisklty=0,staplelty=0)
...
boxplot(sdev,main="Median of SD",xlab="Number of training complexes",ylab="Standard Deviation (Å)",outline=F,boxlty=0,whisklty=0,staplelty=0)
...
boxplot(pcor,main="Median of Rp",xlab="Number of training complexes",ylab="Pearson correlation coefficient",outline=F,boxlty=0,whisklty=0,staplelty=0)
...
boxplot(scor,main="Median of Rs",xlab="Number of training complexes",ylab="Spearman correlation coefficient",outline=F,boxlty=0,whisklty=0,staplelty=0)
...
boxplot(kcor,main="Median of Rk",xlab="Number of training complexes",ylab="Kendall correlation coefficient",outline=F,boxlty=0,whisklty=0,staplelty=0)
