...
par(cex.lab=1.3,cex.axis=1.3,cex.main=1.3)
plot(ntrn,rmsem,main="Median of RMSE",xlab="Number of training complexes",ylab="RMSE")
tiff("tst-sdev-median.tiff",compression="lzw")
par(cex.lab=1.3,cex.axis=1.3,cex.main=1.3)
plot(ntrn,sdevm,main="Median of SD",xlab="Number of training complexes",ylab="SD")
tiff("tst-pcor-median.tiff",compression="lzw")
par(cex.lab=1.3,cex.axis=1.3,cex.main=1.3)
plot(ntrn,pcorm,main="Median of Rp",xlab="Number of training complexes",ylab="Rp")
tiff("tst-scor-median.tiff",compression="lzw")
par(cex.lab=1.3,cex.axis=1.3,cex.main=1.3)
plot(ntrn,scorm,main="Median of Rs",xlab="Number of training complexes",ylab="Rs")
tiff("tst-kcor-median.tiff",compression="lzw")
par(cex.lab=1.3,cex.axis=1.3,cex.main=1.3)
plot(ntrn,kcorm,main="Median of Rk",xlab="Number of training complexes",ylab="Rk")
