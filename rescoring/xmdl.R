...
boxplot(rmse,main="Boxplot of RMSE of models 1, 2, 3 and 4",xlab="Model",ylab="RMSE")
tiff(sprintf("pdbbind-%s-tst-rmse-median.tiff",v),compression="lzw")
par(cex.lab=1.3,cex.axis=1.3,cex.main=1.3)
boxplot(rmse,main="Median of RMSE of models 1, 2, 3 and 4",xlab="Model",ylab="RMSE",outline=F,boxlty=0,whisklty=0,staplelty=0)
tiff(sprintf("pdbbind-%s-tst-sdev-boxplot.tiff",v),compression="lzw")
par(cex.lab=1.3,cex.axis=1.3,cex.main=1.3)
boxplot(sdev,main="Boxplot of SD of models 1, 2, 3 and 4",xlab="Model",ylab="SD")
tiff(sprintf("pdbbind-%s-tst-sdev-median.tiff",v),compression="lzw")
par(cex.lab=1.3,cex.axis=1.3,cex.main=1.3)
boxplot(sdev,main="Median of SD of models 1, 2, 3 and 4",xlab="Model",ylab="SD",outline=F,boxlty=0,whisklty=0,staplelty=0)
tiff(sprintf("pdbbind-%s-tst-pcor-boxplot.tiff",v),compression="lzw")
par(cex.lab=1.3,cex.axis=1.3,cex.main=1.3)
boxplot(pcor,main="Boxplot of Rp of models 1, 2, 3 and 4",xlab="Model",ylab="Rp")
tiff(sprintf("pdbbind-%s-tst-pcor-median.tiff",v),compression="lzw")
par(cex.lab=1.3,cex.axis=1.3,cex.main=1.3)
boxplot(pcor,main="Median of Rp of models 1, 2, 3 and 4",xlab="Model",ylab="Rp",outline=F,boxlty=0,whisklty=0,staplelty=0)
tiff(sprintf("pdbbind-%s-tst-scor-boxplot.tiff",v),compression="lzw")
par(cex.lab=1.3,cex.axis=1.3,cex.main=1.3)
boxplot(scor,main="Boxplot of Rs of models 1, 2, 3 and 4",xlab="Model",ylab="Rs")
tiff(sprintf("pdbbind-%s-tst-scor-median.tiff",v),compression="lzw")
par(cex.lab=1.3,cex.axis=1.3,cex.main=1.3)
boxplot(scor,main="Median of Rs of models 1, 2, 3 and 4",xlab="Model",ylab="Rs",outline=F,boxlty=0,whisklty=0,staplelty=0)
tiff(sprintf("pdbbind-%s-tst-kcor-boxplot.tiff",v),compression="lzw")
par(cex.lab=1.3,cex.axis=1.3,cex.main=1.3)
boxplot(kcor,main="Boxplot of Rk of models 1, 2, 3 and 4",xlab="Model",ylab="Rk")
tiff(sprintf("pdbbind-%s-tst-kcor-median.tiff",v),compression="lzw")
par(cex.lab=1.3,cex.axis=1.3,cex.main=1.3)
boxplot(kcor,main="Median of Rk of models 1, 2, 3 and 4",xlab="Model",ylab="Rk",outline=F,boxlty=0,whisklty=0,staplelty=0)
