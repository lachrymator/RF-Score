...
par(cex.lab=1.3,cex.axis=1.3,cex.main=1.3)
plot(1:4,rmse,main="Median of RMSE of models 1, 2, 3 and 4",xlab="Model",ylab="RMSE",xaxt="n")
axis(1,1:4)
tiff(sprintf("pdbbind-%s-tst-sdev-median.tiff",v),compression="lzw")
par(cex.lab=1.3,cex.axis=1.3,cex.main=1.3)
plot(1:4,sdev,main="Median of SD of models 1, 2, 3 and 4",xlab="Model",ylab="SD",xaxt="n")
axis(1,1:4)
tiff(sprintf("pdbbind-%s-tst-pcor-median.tiff",v),compression="lzw")
par(cex.lab=1.3,cex.axis=1.3,cex.main=1.3)
plot(1:4,pcor,main="Median of Rp of models 1, 2, 3 and 4",xlab="Model",ylab="Rp",xaxt="n")
axis(1,1:4)
tiff(sprintf("pdbbind-%s-tst-scor-median.tiff",v),compression="lzw")
par(cex.lab=1.3,cex.axis=1.3,cex.main=1.3)
plot(1:4,scor,main="Median of Rs of models 1, 2, 3 and 4",xlab="Model",ylab="Rs",xaxt="n")
axis(1,1:4)
tiff(sprintf("pdbbind-%s-tst-kcor-median.tiff",v),compression="lzw")
par(cex.lab=1.3,cex.axis=1.3,cex.main=1.3)
plot(1:4,kcor,main="Median of Rk of models 1, 2, 3 and 4",xlab="Model",ylab="Rk",xaxt="n")
axis(1,1:4)
